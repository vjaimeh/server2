...
class Games
{
    public function getListTypeQuestions($ds, $params)
    {
        $listsArray = [];
    ...
    public function getListCategories($ds, $idGame)
    {
        $listsArray = [];
    ...
    //newGame crear juego
    public function newGame_typeOne($ds, $params)
    {
        $message = new Message();
        $user = new User();
        $listsArray = [];
    ...
    //newGame crear juego
    public function newGame_typeTwo($ds, $params)
    {
        $message = new Message();
        $user = new User();
        $listsArray = [];
    ...
    public function newGame($ds, $params)
    {
        $message = new Message();
        $user = new User();
        $listsArray = [];
    ...
    public function validateAmphitryon($ds, $params)
    {
        $listsArray = [];
        $validate=false;
        $query="
    ...
    public function aceptedInvitation($ds, $params)
    {
        $listsArray = [];
    ...
    public function getOptionsByIdQuestion($ds, $idQuestion)
    {
        $listsArrayOptions = [];
    ...
    public function insertGamePlay($ds, $idUser, $idQuestion)
    {
        $status=false;
    ...
    public function getLastIdGameplay($ds)
    {
        $lastIdGameplay=0;
        $query= "
    ...
    public function insertGameplayUser($ds, $lastIdGameplay, $idUserInvited)
    {
        $status=false;
    ...
    public function getGamePlayById($ds, $params)
    {
        $listsArray = [];
        $listsArrayOptions = [];
        $user = new User();
        ...
        $paramRes["user_id"] = $params["user_id"];
        $paramRes["isAmphitryon"]=$params["isAmphitryon"];
        array_push($listsArray, [
            ...
            'answers' => $this->getAsks($ds, $paramRes),
            //'answers' =>  $this->getAskGameplayById($ds, $lastIdGameplay)
    ...
    public function getMyGamePlayByIdUser($ds, $params)
    {
    ...
    public function getMyGamePlayByIdUserAmphitryon($ds, $params)
    {
        $sum=0;
        $listsArray = [];
        $listsArrayOptions = [];
            ...
            while ($row = $stmt->fetch()) {
                if ($row['idGameplay']!= null) {
                    ...
                    array_push($listsArray, [
                        ...
                        'status'   => $paramStatus,
                        'question'   => $paramQuestion,
                        'answers' =>  $this->comparateAsks($ds, $paramRes),
                        'listUsers' =>  $user->getListUserByGamePlayId($ds, $paramRes)
    ...
    public function getMyGamePlayByIdUserUser($ds, $params)
    {
        $listsArray = [];
        $listsArrayOptions = [];
        $user = new User();
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public function getStatusGameplayById($ds, $idGamePlay)
    {
        $query= "
    ...
    public function getAskGameplayById($ds, $idGamePlay)
    {
        $listsArray = [];
        $listsArrayAmphitryon = [];
        $listsArrayFriend = [];
    ...
    public function getOptionQuestionsById($ds, $idOption)
    {
        $listsArray = [];
    ...
    public function getListGamesById($ds, $params)
    {
        $listsArray = [];
    ...
    public function getListQuestionsById($ds, $idCatGame)
    {
        $listsArray = [];
    ...
    public function getListOptionQuestionsById($ds, $idQuestion)
    {
        $listsArray = [];
    ...
    public function getListCategoryById($ds, $idGame)
    {
        $listsArray = [];
    ...
    public function getSearchGamesByParams($ds, $params)
    {
        $listsArray = [];
    ...
    //getGame
    public function getGame($params, $ds)
    {
        $listsArray = [];
        $listsCategoryArray = [];
    ...
    //Comparation
    public function sendReply($ds, $params)
    {
    ...
    public function exitsGamePlay($ds, $params)
    {
        $listsArray = [];
    ...
    public function validateGamePlay($ds, $params)
    {
        $listsArray = [];
        $validate=false;
        $query="
    ...
    public function validateQuestion($ds, $params)
    {
        $listsArray = [];
        $validate=false;
    ...
    public function isAmphitryon($ds, $params)
    {
        $listsArray = [];
        $isAmphitryon=false;
        $query="
    ...
    public function insertOrUpdateAsk($ds, $params)
    {
        $listsArray = [];
        $params["idAsk"]=-1;
    ...
    public function getAsks($ds, $params)
    {
        $user = new User();
        $listsArray = [];
        $query="
        ...
        if ($stmt->rowCount() > 0) {
            while ($row = $stmt->fetch()) {
                if ($row['id']!= null) {
                    ...
                    $paramRes["message"]="Ambos ya respondieron.";
                    if ($paramRes["askIdFriend"] == "") {
                        $paramRes["message"]="-Tu invitado aun no responde.";
                    } elseif ($paramRes["askIdAmphitryon"]=="") {
                        $paramRes["message"]="-Aun no has respondido.";
                    }
                } else {
                    $paramRes["message"]="-Ningun usuario a ha respondido.";
                }
            }
        }
        return $paramRes;
    ...
    public function deleteGameplayById($ds, $params)
    {
        $listsArray = [];
    ...
    public function getGameById($id, $ds)
    {
    ...
    public function getStatusAllMyGames()
    {
    }
    public function getStatusByIdPlay()
    {
    }


    public function getEmailAmphitryonByIdGameplay($ds, $id)
    {
        $email = "";
        $query="
		SELECT u.email
    ...
    public function getEmailInvitedByIdGameplay($ds, $idGameplay)
    {
        $email = "";
        $query="
		SELECT u.email
		FROM game_play gp
		INNER JOIN game_play_users gpu
    ...
    public function sendNotificationFinishGamePlay($ds, $idGameplay)
    {
        $notification = new OneSignalNotification();
