...
class Medal
{
    ...
    public function getAllMedals($ds, $params)
    {
        $listsArray = [];
        $nMedals=0;
    ...
    public function getCategoryMedalsById($ds, $idMedal)
    {
        $listsArray = [];
    ...
    public function getSubMedalsById($ds, $idCategory)
    {
        $listsArray = [];
    ...
    public function getAllMedalsByIdUser($ds, $params)
    {
        $listsArray = [];
        $listsSubmedalsArray=[];
        $user = new User();
    ...
    public function insertOrUpdateUserMedals($ds, $params)
    {
        $listsArray = [];
        $idUserMedal=-1;
