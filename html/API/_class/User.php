...
class User
{
    ...
    public $dir_users="https://tland-dev.karaokulta.com/API/___assets/_imgs/_profile/";
    ...
    public function loginSocial_facebook($ds, $params)
    {
        $listsArray = [];
        $dir_users="https://tland-dev.karaokulta.com/API/___assets/_imgs/_profile/";
        $medal = new Medal();
    ...
    public function updateSocial_facebook($ds, $params)
    {
    ...
    */
    ...
    public function getListUserSendRequest($params, $ds)
    {
        $listsArray = [];
        $dir_users="https://tland-dev.karaokulta.com/API/___assets/_imgs/_profile/";
        $querySendList= "
